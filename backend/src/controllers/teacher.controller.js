...
const createTeacher = catchAsync(async (req, res) => {
  ...
  if (employeeIdExists) {
    throw new AppError(`Teacher with employee ID '${employeeId}' already exists in this school.`, 409);
  }
...
const getTeacherById = catchAsync(async (req, res) => {
  ...
  if (teacher.school.toString() !== req.user.school.toString()) {
    throw new AppError('Access denied: Teacher belongs to another school.', 403);
  }
